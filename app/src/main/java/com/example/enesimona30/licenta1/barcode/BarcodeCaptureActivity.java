...
import com.example.enesimona30.licenta1.ResultActivity;
import com.example.enesimona30.licenta1.RouletteActivity;
import com.example.enesimona30.licenta1.camera.CameraSource;
import com.example.enesimona30.licenta1.camera.CameraSourcePreview;
...
public final class BarcodeCaptureActivity extends AppCompatActivity
    ...
    public void onDetectedQrCode(Barcode barcode) {
        if (barcode != null) {
            ResultActivity.barcode=barcode;
            ...
            while(st.hasMoreElements()){
                ...
                Log.i("STRINGS", st.nextElement().toString());
            }
            if(strings.get(0).equalsIgnoreCase("1993058401")) {
